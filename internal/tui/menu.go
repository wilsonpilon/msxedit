	...
	return []MenuDefinition{
		{
			...
			Items: []MenuEntry{
				...
				{Label: "Save a&ll", Action: func() { app.showSaveAll() }},
				{Separator: true},
				{Label: "&Change dir...", Action: func() { app.showChangeDir() }},
				{Label: "&Print", Action: func() { app.showPrint() }},
				{Label: "P&rinter setup...", Action: func() { app.showPrinterSetup() }},
				{Label: "&Powershell", Action: func() { app.showPowerShell() }},
